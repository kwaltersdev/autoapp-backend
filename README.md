# Auto Inventory Flow Back End Demo
Written in TypeScript/Node/Express, this back end application is meant for use with [Auto Inventory Flow Front End](https://github.com/kwaltersdev/autoapp-front-end-demo).
