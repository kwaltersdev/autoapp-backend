...
Written in TypeScript/Node/Express, this back end application is meant for use with [Auto Inventory Flow Front End](https://github.com/kwaltersdev/autoapp-frontend).
